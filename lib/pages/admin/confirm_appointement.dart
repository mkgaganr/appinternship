...
class CommitAppointmentPage extends StatefulWidget {
  ...
  final String id;
  const CommitAppointmentPage({ Key key, this.data, this.id }) : super(key: key);
  _CommitAppointmentPageState createState() => _CommitAppointmentPageState();
}
                ...
                MyButton(
                    onPressed: (){
                      if(_formKey.currentState.validate()){
                        ...
                        Firestore.instance.collection("Appointment Bookings").add(data);}}, text: "Confirm Appointmemt"
                ),  // MyButton
                SizedBox(
                  height: 20,
                ),
